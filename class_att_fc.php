...
<div class="all_student fix">
		...
		<div  class="fix" style="background:#ddd;padding:20px;">
			<span style="text-align:center;"><a style="color:#fff; font-weight:bold" href="att_view_fc.php"> <button style="background:#58A85D;border:none;color:#fff;padding:10px;">View Attendance</button></a></span>
			<a href="st_result.php" style="background:black;border:none;color:#fff;padding:10px;  font-weight:bold">Result</a>
			<a href="subjects_add_fct.php" style="background:blue;border:none;color:#fff;padding:10px;  font-weight:bold">Add Subject</a>
			<a href="subjects_manage_fct.php" style="background:maroon;border:none;color:#fff;padding:10px; font-weight:bold">Manage Subjects</a>
		</div>
		<?php
